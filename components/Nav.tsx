...
export default function Nav() {
  return (
    <View className="flex-row gap-5 items-center justify-between mx-5 mt-3">
        <Pressable className="w-14 h-14 items-center justify-center bg-white rounded-full active:bg-white">
            <Entypo name="chevron-left" size={30} color="black"/>
        </Pressable>
        <View className="flex-row gap-2 items-center flex-1 ">
            <Image source={xefagLogo} style={{ width: 130, height: 110 }} />
        </View>
        <Pressable className="w-14 h-14 items-center justify-center bg-black/40 rounded-full active:bg-white"
              style={{ backgroundColor: 'rgb(240, 133, 11)' }}>
